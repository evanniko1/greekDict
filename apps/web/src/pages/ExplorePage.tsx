    ...
    >
      ...
      {data && (
        <p className="mt-3 text-xs text-slate-400 dark:text-slate-500">
          ✸ = στατιστικά σημαντική τάση (έλεγχος Mann–Kendall, μη παραμετρικός, με
          διόρθωση Benjamini–Hochberg για τους πολλαπλούς ελέγχους — q &lt; 0,05). Το R²
          δείχνει πόσο σταθερή είναι η τάση. Επειδή ελέγχονται ταυτόχρονα χιλιάδες λέξεις,
          χωρίς τη διόρθωση FDR ένα 5% τους θα έβγαινε «σημαντικό» από τύχη.
        </p>
      )}
    </SectionCard>
  );
